...
Estados necessarios para a aplicação :
 ...
 A fase de montagem possui multiplos métodos, sendo eles: **componentWillMount**, **render** e **componentDidMount**
 
 #### componentWillMount
 
 É executado assim que o componente estiver prestes a ser montado no DOM, aqui devem ir todas as coisas que você deseja fazer antes do componente aparecer, por exemplo:
 Chamar algum método externo, resetar algum estado etc...
 
 #### render
 
 este método monta um componente no navegador
 
 #### componentDidMount
 
 É executado após o componente ser montado no DOM, com esse método podemos acessar o DOM.
 
 ### Atualização
 
 A fase de atualização também possui multiplos métodos, sendo eles: **componentWillReceiveProps**, **shouldComponentUpdate**, **componentWillUpdate**, **render**, **componentDidUpdate**
 
 #### componentWillReceiveProps
 
 Este método é chamado antes do componente receber novas props.
 
 #### shouldComponentUpdate
 
 Este método serve para controlar se o componente deve ou não ser atualizado, após alguma prop ou state ser alterado.
 
 #### componentWillUpdate
 
 Este métodos é executado antes da renderização de novas props ou states recebidos.
 
 #### render
 
 É chamado para renderizar em tela o componente atualizado
 
 #### componentDidUpdate
 
 Este método é chamado após a re-renderização do componente
 
 ### Desmontagem
 
 Este ciclo possui apenas um método: **componentWillUnmount**
 
 #### componentWillUnmount
 
 É chamado antes de um componente ser desmontado, é util para resetar state
